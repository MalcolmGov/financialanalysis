    ...
    JSON.stringify(
      {
        ...
        hasCurCol: assembledHtml.includes("data-cur-col="),
        hasCurClass: assembledHtml.includes('class="cur"') || assembledHtml.includes(" class=\"cur\""),
        hasCurCss: assembledHtml.includes("td.cur"),
        hasProseMeasure: assembledHtml.includes("--rs-prose:68ch"),
        ...
        curColCount: (assembledHtml.match(/data-cur-col=/g) ?? []).length,
      },
      null,
      2,
    ) + "\n",
