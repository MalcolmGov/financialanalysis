...
| **SPAR** | `7947eb5f-d836-43b4-8779-8bfdcf164471` | 80 pp | AFS dual-entity | **15** (draft v31) | `editorial` | **Expanded** — directors + auditor + policies + note groups; commentary from DR (~70k); Gate A/B pass |
